            ...
            <div class="card profile-details">
                ...
                <div class="profile-details-header">
                    <div>
                        ...
                        <p>user information  in Detail</p>
                    </div>
                </div>
                ...
                <form method="POST" id="editUserForm">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="phone" placeholder="+91 98765 43210" Id="Phone" value="<?= htmlspecialchars($user['phone']) ?>">
                           <div class="PhoneError" style="color:red" ></div>
                        
                        </div>
                        <div class="field">
                            <label>Date of Birth</label>
                            <input type="date" name="age" id="Age" value="<?= htmlspecialchars($user['dob']) ?>">
